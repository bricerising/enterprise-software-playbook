...
- Median non-trivial output size increases by >20% with no measurable reduction in avoidable follow-up defects/incidents.
...
- **Leading indicators (early)**:
  - Non-trivial outputs include explicit assumption/second-order/opportunity-cost sections.
